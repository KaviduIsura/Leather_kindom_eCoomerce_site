...
if(isset($_SESSION['auth']))
{
    if(isset($_POST['placeOrderBtn']))
    {
        ...
        {
          $_SESSION['message']="All fiedls are manditory";
          header('Location:../checkout.php');
          exit(0);
        }

        $userID=$_SESSION['auth_user']['user_id'];
        $query="SELECT c.id as cid, c.prod_id, c.prod_qty, p.id as pid, p.name,p.image, p.selling_price FROM carts c,
        ...
        $tracking_no = "LetherKindom".rand(1111,9999).substr($phone,2);
          ...
          foreach($query_run as $citem)
            {
              ...
              $insert_item_query = "INSERT INTO order_items (order_id, prod_id, qty, price) VALUES ('$order_id',
                                    '$prod_id', '$prod_qty', '$price')";
